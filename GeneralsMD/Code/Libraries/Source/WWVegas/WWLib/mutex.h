...
public:
	...
	public:
		...
		{
		  // Original code used inline x86 assembly with LOCK BTS spinlock.
		  // Replaced with MSVC intrinsic for modern compiler compatibility.
		  while (_interlockedbittestandset((volatile long*)&cs.Flag, 0)) {
